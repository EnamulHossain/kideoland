                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <small class="text-muted">{{ translate('Minimum dimensions required: 150px width X 150px
                                height.') }}</small>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <small class="text-muted">{{ translate('Minimum dimensions required: 16px width X 16px
                                height.') }}</small>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <small class="text-muted">{{ translate('Minimum dimensions required: 318px width X 340px
                                height.') }}</small>
                        </div>
                    </div>
                    <div class="form-group row">
