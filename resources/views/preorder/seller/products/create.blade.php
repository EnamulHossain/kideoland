                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Gallery
                                Images')}}<small>(600x400)</small></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail
                                Image')}}<small>(300x200)</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
                                ...
                                <small class="text-muted">{{translate('Upload a primary image at 300x200 pixels for
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="col-md-9">
                                        <div class=" mb-4 row">
                                            <div class="col-md-4 radio mar-btm mt-2 align-items-center">
                                                ...
                                                <span>{{translate('Select this option if the Prepayment amount is
                                                    fixed')}}</span>
                                            </div>
                                            <div class="col-md-6 radio mar-btm mt-2 align-items-center">
                                                <div>
                                                    ...
                                                    <label for="fq_bought_select_products"
                                                        class="fs-14 fw-700 mb-0 ml-2">{{translate('Needed only for Cash
                                                        On Delivery')}}</label>
                                                </div>
                                                <span>{{translate('Select if the Prepayment is only for Cash On
                                                    Delivery')}}</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="coupons">
                            ...
                            <div id="couponBlock" style="display: none">
                                {{-- <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Show Other Counpons For This
                                        Seller')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
